...
@section('content')
    ...
    <section class="admin-show-grid">
        <div class="admin-panel-card">
            ...
            @endif
                ...
                <div class="spec-grid">
                    ...
                    <div><strong>Rating</strong><span>{{ number_format((float) $product->average_rating, 1) }}/5</span></div>
        ...
        <div class="admin-panel-card">
            ...
            <h2>Meta title</h2>
            <p>{{ $product->meta_title ?: 'No meta title' }}</p>

            <h2>Meta description</h2>
            <p>{{ $product->meta_description ?: 'No meta description' }}</p>
